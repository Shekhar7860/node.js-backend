...
async getPeriod ()  {
  ...
  componentDidMount() {
    const datafromHtml = JSON.parse(localStorage.getItem('test'));
    console.log('html data', datafromHtml)
 ...
 //   setQuery(q);
  ...
  render() {
    return (
      <div className="filter-block" style={{margin : 30}}>
        {!this.state.showNewsletter ? <div><header id="masthead" role="banner">
      ...
      /></a>
            ...
            </header><div style={{fontSize: 25,
      fontWeight: 'bold'}}>Generate Newsletter</div></div> : null}
                            ...
                            <AsyncTypeahead
                              ...
                              onChange={(selected) => {
                               // console.log('selected', selected)
                                ...
                                // const newsletter_filter = this
                                //   .newsletter_filter;
                                // this.setState({
                                //   start_date:
                                //     typeof selected[0] === "undefined"
                                //       ? 0
                                //       : new Date(selected[0].start),
                                //   end_date:
                                //     typeof selected[0] === "undefined"
                                //       ? ""
                                //       : new Date(selected[0].end),
                                // });
                                // if (typeof selected[0] === "undefined") {
                                //   newsletter_filter["period"] = [];
                                // } else {
                                //   newsletter_filter["period"] = {
                                //     period_id: selected[0].id,
                                //     start_date: selected[0].start,
                                //     end_date: selected[0].end,
