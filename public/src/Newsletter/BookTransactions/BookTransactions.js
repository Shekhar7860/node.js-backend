...
class BookTransactions extends React.Component {
	constructor() {
		super();
	this.state = {
	...
	render() {
		let bookTypes = {
			mbig: {
				...
				image: './images/newsletter/maha-books.png',
				points:
			...
			big: {
				title: 'Big Books',
				image: './images/newsletter/Bigbooks.png',
				points:
					this.state.bookTypeTransactions !== null
			...
			medium: {
				title: 'Medium Books',
				image: './images/newsletter/mediumbooks.png',
				points:
					this.state.bookTypeTransactions !== null
			...
			small: {
				title: 'Small Books',
				image: './images/newsletter/Smallbooks.png',
				points:
					this.state.bookTypeTransactions !== null
			...
			magazines: {
				title: 'Magazines',
				image: './images/newsletter/magazines.png',
				points:
					this.state.bookTypeTransactions !== null &&
			...
			btg: {
				...
				image: './images/newsletter/subscription.png',
				points:
					this.state.bookTypeTransactions !== null
			...
			full: {
				title: 'Full Sets',
				image: './images/newsletter/fullsets.png',
				points:
					this.state.bookTypeTransactions !== null
				...
				<div className='output'>
					<div className='full-box'>
						<div className='images-block'>
							<img src='./images/guru-ji.png' alt='Medium books' />
						</div>
